...
else
{
	...
	$groups 	= $communityController->getModel( 'Groups' );
	...
	$mailList 	= $mailque->getunsendMailList();
	...
	$total = $groups->getPendingGroups() + $events->getPendingEvents() + $reports->getPendingCount() + $users->getPendingMember() + $mailque->getUnsendMail();
	...
	$view->set('pendingGroup',$groups->getPendingGroups());
	$view->set('pendingEvent',$events->getPendingEvents());
	$view->set('reportCount',$reports->getPendingCount());
	$view->set('pendingUser',$users->getPendingMember());
	$view->set('unsendCount',$mailque->getUnsendMail());
