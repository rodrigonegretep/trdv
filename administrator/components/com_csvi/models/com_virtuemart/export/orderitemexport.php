 ...
 * @version 	$Id: orderitemexport.php 2549 2013-11-26 01:42:51Z RolandD $
 */
...
class CsviModelOrderitemExport extends CsviModelExportfile {
	...
	public function getStart() {
		...
		$ordernostart = $template->get('orderitemnostart', 'orderitem', 0, 'int');
		if ($ordernostart > 0) {
			$selectors[] = '#__virtuemart_order_items.virtuemart_order_id >= '.$ordernostart;
		}

		// Filter by order number end
		$ordernoend = $template->get('orderitemnoend', 'orderitem', 0, 'int');
		if ($ordernoend > 0) {
