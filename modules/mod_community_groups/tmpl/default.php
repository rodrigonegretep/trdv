		...
		?>
			<li>
				<a href="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=viewgroup&groupid='.$group->id); ?>">
					<img src="<?php echo $group->getThumbAvatar(); ?>" alt="<?php echo CStringHelper::escape($group->name); ?>" class="cAvatar cGroupAvatar jomNameTips" title="<?php echo htmlspecialchars( JText::_( CStringHelper::escape($group->name) )); ?>" />
				</a>
			</li>
		<?php
			}
