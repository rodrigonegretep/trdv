				...
				<li id="friend-<?php echo $user->id;?>">
					<div class="cIndex-Box clearfix">
						...
						<div class="cIndex-Content">
							<h4 class="cIndex-Name reset-gap"><?php echo $user->getDisplayName(); ?></h4>
							<div class="cIndex-Actions">
									<a href="javascript:void(0);" class="btn btn-primary" onclick="joms.users.unBlockUser('<?php echo $row->blocked_userid;  ?>','privacy');">
