	...
	<div class="js-focus-cover">
		...
		<div class="js-focus-change-cover" data-cover-type="cover">
			 <?php if(!$profile->defaultCover){?>
			 	<a href="javascript:void(0)" class="btn" data-cover-context="profile" onclick="joms.cover.reposition(this, <?php echo $profile->id; ?>,'<?php echo JText::_("COM_COMMUNITY_CANCEL_BUTTON")?>','<?php echo JText::_("COM_COMMUNITY_SAVE_BUTTON")?>');"><i class="js-icon-cog"></i><?php echo JText::_('COM_COMMUNITY_REPOSITION_COVER')?></a>
			 <?php }?>
			 	<a href="javascript:void(0)" class="btn ml-6" data-cover-context="profile" onclick="joms.cover.select(this, <?php echo $profile->id; ?>);" ><i class="js-icon-picture"></i><?php echo JText::_('COM_COMMUNITY_CHANGE_COVER'); ?></a>
		</div>
		<?php }?>
