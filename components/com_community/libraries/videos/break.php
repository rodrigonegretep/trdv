...
class CTableVideoBreak extends CVideoProvider
{
	...
	public function getViewHTML($videoId, $videoWidth, $videoHeight)
	{
		...
		$html .= "<embed src=\"".  CVideosHelper::getIURL($videoUrl)."\" width=\"".$videoWidth."\" height=\"".$videoHeight."\" wmode=\"transparent\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" type=\"application/x-shockwave-flash\" allowFullScreen=\"true\"> </embed>";
