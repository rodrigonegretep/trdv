...
class CTableVideoYahoo extends CVideoProvider
{
	...
	{
		$embedCode = (ctype_digit($videoId))
					? '<embed type="application/x-shockwave-flash" src="'.CVideosHelper::getIURL('http://d.yimg.com/nl/cbe/paas/player.swf').'" width="'.$videoWidth.'" height="'.$videoHeight.'" style="undefined" id="yppVideoPlayer22353" name="yppVideoPlayer22353" bgcolor="#000000" quality="high" allowfullscreen="true" allowscriptaccess="always" wmode="transparent" tabindex="999" flashvars="eventHandler=window.YEP36272.playerEvents&amp;autoPlay=true&amp;infoScreenUI=show&amp;shareScreenUI=hide&amp;startScreenCarouselUI=hide&amp;embedCode=on&amp;vid='.$videoId.'&&amp">'
