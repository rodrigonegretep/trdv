...
class CWall
{
	...
	public static function formatComment($wall)
	{
		...
		{
			$editHTML= '<span><a href="javascript:void(0)" onClick="joms.comments.edit('.$wall->id.','.$wall->contentid.' , this)">'. JText::_('COM_COMMUNITY_EDIT') .'</a></span>';
		}
        /* user deleted */
        if ( $user->guest == 1 ) {
		...
		<div class="cStream-Comment stream-comment clearfix" data-commentid="'.$wall->id.'">
			...
			<div class="cStream-Content">
				...
				<span class="comment">'.CLinkGeneratorHelper::replaceAliasURL($wall->comment).'</span>
