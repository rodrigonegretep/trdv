...
class CommunityViewSearch extends CommunityView
{
	...
	public function field($data)
	{
		...
		$document->setTitle( JText::sprintf( 'COM_COMMUNITY_MEMBERS_WITH_FIELD', JText::_( $profileName ) , JText::_($vals[0] )) );
	...
	public function advanceSearch()
	{
		...
		$avatarOnly	= $jinput->get('avatar' , '', 'NONE'); //JRequest::getVar( 'avatar' , '' );
